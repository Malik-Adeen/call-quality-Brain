...
> Next: [[08_Phase2.1_Postmortem]] · Index: [[00_Master_Dashboard]]
...
| Pydantic ValidationError on worker startup | MinIO fields were required in config.py | Made minio fields Optional[str] = None |
...
- `depends_on: condition: service_started` throughout
